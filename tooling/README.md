...
Platform tenant provisioning (`sesame-idam tenant …`) is documented in [CONTRIBUTING.md](../CONTRIBUTING.md#platform-tenant-administration) with tenant-agnostic examples.
