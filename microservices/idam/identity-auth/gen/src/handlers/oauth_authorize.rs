...
impl TryFrom<HandlerRequest> for Request {
    ...
    fn try_from(req: HandlerRequest) -> Result<Self, Self::Error> {
        ...
        if let Some(v) = req.get_query_param("response_type") {
            ...
            return Err(anyhow::anyhow!("Missing required parameter 'response_type'"));
        ...
        if let Some(v) = req.get_query_param("prompt") {
        
            data_map.insert(
                "prompt".to_string(),
                brrtrouter::server::request::decode_param_value(
                    v,Some(&serde_json::json!({"enum":["login","consent","none","select_account"],"type":"string"})),None,None,
                ),
            );
        } else {
