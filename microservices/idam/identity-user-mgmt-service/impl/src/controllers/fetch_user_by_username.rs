...
// Implementation stub for handler 'fetch_user_by_username'
// This file is a starting point for your implementation.
// You can modify this file freely - it will NOT be auto-regenerated.
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path fetch_user_by_username --force

use brrtrouter_macros::handler;
use sesame_idam_identity_user_mgmt_service_gen::handlers::fetch_user_by_username::{Request, Response};
use brrtrouter::typed::TypedHandlerRequest;



/// Handler for Fetch User By Username.
