...
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path auth_token --force
...
pub fn handle(req: TypedHandlerRequest<Request>) -> Response {
    ...
    // let client_id = req.inner.client_id;// let client_secret = req.inner.client_secret;// let grant_type = req.inner.grant_type;// let refresh_token = req.inner.refresh_token;// let requested_token_type = req.inner.requested_token_type;// let scope = req.inner.scope;// let subject_token = req.inner.subject_token;// let subject_token_type = req.inner.subject_token_type;
    //
