...
impl TtlConfig {
    ...
    pub fn from_env_and_config(
        ...
        Self {
            ...
            admin_refresh_days: DEFAULT_ADMIN_REFRESH_TTL_DAYS,
        }
    }
...
mod tests {
    ...
    fn test_from_env_and_config_env_overrides() {
        ...
        std::env::set_var("JWT_ACCESS_TTL_NORMAL", "600");
        let config =
            TtlConfig::from_env_and_config(Some(300), Some(300), Some(300), Some(300), Some(30));
        ...
        let config2 =
            TtlConfig::from_env_and_config(Some(600), Some(300), Some(300), Some(300), Some(30));
        assert_eq!(
