...
impl TryFrom<HandlerRequest> for Request {
    ...
    fn try_from(req: HandlerRequest) -> Result<Self, Self::Error> {
        ...
        if let Some(v) = req.get_path_param("export_id") {
            data_map.insert(
                "export_id".to_string(),
            ...
            return Err(anyhow::anyhow!("Missing required parameter 'export_id'"));
        }
...
pub fn handler(req: TypedHandlerRequest<Request>) -> Response {
    crate::controllers::check_export_status::handle(req)
}
