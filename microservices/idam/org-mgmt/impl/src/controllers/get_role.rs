...
// Implementation stub for handler 'get_role'
// This file is a starting point for your implementation.
// You can modify this file freely - it will NOT be auto-regenerated.
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path get_role --force

use brrtrouter_macros::handler;
use sesame_idam_org_mgmt_gen::handlers::get_role::{Request, Response};
