...
// Implementation stub for handler 'list_permissions'
// This file is a starting point for your implementation.
// You can modify this file freely - it will NOT be auto-regenerated.
// To regenerate this stub, use: brrtrouter-gen generate-stubs --path list_permissions --force

use brrtrouter_macros::handler;
use sesame_idam_org_mgmt_gen::handlers::list_permissions::{Request, Response};
